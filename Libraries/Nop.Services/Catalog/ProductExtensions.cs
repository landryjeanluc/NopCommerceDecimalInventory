...
namespace Nop.Services.Catalog
{
    ...
    public static class ProductExtensions
    {
        ...
        public static TierPrice GetPreferredTierPrice(this Product product, Customer customer, int storeId, decimal quantity)
        {
        ...
        public static decimal[] ParseAllowedQuantities(this Product product)
        {
            ...
            if (!String.IsNullOrWhiteSpace(product.AllowedQuantities))
            {
                product.AllowedQuantities
                    ...
                    {
                        decimal qty;
                        if (decimal.TryParse(qtyStr.Trim(), out qty))
                        {
                            result.Add(qty);
                        }
                    });
        ...
        /// </param>
        /// <returns>Result</returns>
        public static decimal GetTotalStockQuantity(this Product product, 
