...
namespace Nop.Services.Orders
{
    public static class OrderExtensions
    {
        ...
        public static decimal GetTotalNumberOfItemsInAllShipment(this OrderItem orderItem)
        {
            if (orderItem == null)
        ...
        public static decimal GetTotalNumberOfItemsCanBeAddedToShipment(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static decimal GetTotalNumberOfNotYetShippedItems(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static decimal GetTotalNumberOfShippedItems(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static decimal GetTotalNumberOfDeliveredItems(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
